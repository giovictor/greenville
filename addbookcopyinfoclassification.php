...
if(isset($_POST['bookID']) && isset($_POST['classification'])) {
	$bookID = $_POST['bookID'];
...
$(document).ready(function(){
	$("#addcopyform").submit(function(e){
		...
		if(newcopies=="") {
			...
			$.ajax({
				url:"addbookcopiesclassification.php",
				method:"POST",
				data:{bookID:bookID, newcopies:newcopies, classification:classification},
				beforeSend:function() {
