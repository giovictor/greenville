<aside class="adminsidebar">
	<ul>	
		...
		<li>
			<a href="?page=borrowbook"><span class="glyphicon glyphicon-book"></span> Borrow Book</a>
		</li> 
		<li>
		...
		<li>
			...
			<div class="collapse" id="submenuborrower">
				...
				<li><a href="?page=borrowers">Borrower List <span class="glyphicon glyphicon-list"></span></a></li>
			</div>
		<li>
			<a href="?page=vrs"><span class="glyphicon glyphicon-book"></span> Reservations</a>
		</li> 
		<li>
			<a href="?page=vbr"><span class="glyphicon glyphicon-book"></span> Borrowed Books</a>
		</li> 
		<li>
